...
`~/.exports-local`, which is ignored by Git and loaded by both Bash and Zsh:

```sh
export SRCDIR="$HOME/code"
```
...
```bash
git clone https://github.com/nbonamy/dotfiles.git && cd dotfiles && ./sync.sh
```
